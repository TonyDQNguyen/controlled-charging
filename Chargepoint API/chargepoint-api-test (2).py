...
##charge_sessions = client.service.getStationStatus(searchQuery = {'stationID':'1:115893','portDetails':True})
...
##print client.service.getLoad(searchQuery = {'sgID':'61001','sgID':'61005'})
